...
const getAllUsers = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const totalUsers = yield user_model_1.User.countDocuments({ isDeleted: { $ne: true } });
    return {
        data: users,
        meta: {
            total: totalUsers,
...
const updateUserStatus = (userId, status) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (user.isActive === user_interface_1.IsActive.ACTIVE && status !== user_interface_1.IsActive.BLOCKED) {
        throw new AppError_1.default(http_status_codes_1.default.BAD_REQUEST, "Active user can only be blocked");
    }
...
const deleteUser = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updatedUser = yield user_model_1.User.findByIdAndUpdate(userId, { isDeleted: true }, { new: true, runValidators: true });
    return updatedUser;
});
